...
Data Preprocessing: The input data is pre-processed to handle missing values, normalize or scale features, and transform categorical variables.
...
Bootstrap : Used the Bootstrap classes to make frontend more appealing. 
